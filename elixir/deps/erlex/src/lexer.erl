...
yystate(40, [C|Ics], Line, Tlen, Action, Alen) when C >= 0, C =< 8 ->
    yystate(42, Ics, Line, Tlen+1, Action, Alen);
yystate(40, [C|Ics], Line, Tlen, Action, Alen) when C >= 14, C =< 31 ->
    yystate(42, Ics, Line, Tlen+1, Action, Alen);
...
yystate(40, [C|Ics], Line, Tlen, Action, Alen) when C >= 63, C =< 90 ->
    yystate(42, Ics, Line, Tlen+1, Action, Alen);
yystate(40, [C|Ics], Line, Tlen, Action, Alen) when C >= 96, C =< 101 ->
    yystate(42, Ics, Line, Tlen+1, Action, Alen);
yystate(40, [C|Ics], Line, Tlen, Action, Alen) when C >= 103, C =< 122 ->
    yystate(42, Ics, Line, Tlen+1, Action, Alen);
...
yystate(38, [10|Ics], Line, Tlen, _, _) ->
    yystate(38, Ics, Line+1, Tlen+1, 0, Tlen);
...
yystate(1, [10|Ics], Line, Tlen, _, _) ->
    yystate(2, Ics, Line+1, Tlen+1, 25, Tlen);
